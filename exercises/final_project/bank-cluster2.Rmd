...
X_NB = subset(bank, select = -c(y))  # feature matrix
y_NB = 0+{bank$y == 'yes'}  # target variable
...
X_train<-replace(X_train, ok, +1/D)
...
pvec_0 = colSums(X_train[y_train==0,])  ## debug do one-hot encoding
